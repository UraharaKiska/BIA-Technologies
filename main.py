...
def create_shedule(current_month):
    ...
    workers_name = get_name_from_database()
    ...
    #     workers_status[] = 'в'      # по дефолту у всех выходной
    ...
    for i in range(1, day_count + 1 ):         # проходимся по каждоиу дню в месяце
        ...
        shedule[i]['weekday'] = WEEKDAYS[(i + offset - 1) - (i + offset - 1) // 7 * 7]  # просчитываем текущий день недели
